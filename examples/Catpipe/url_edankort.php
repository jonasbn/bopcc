...
<body onLoad="//tjuhej('onLoad');">
	<!-- a hidden form for eDankort -->
        ...
        <form name=AuthenticationInitialization
			action="https://www.authentication-router.pbs.dk/RouterWebApp/servlet/EDKTransfer"
			method="post" 
			target="_top">

		<input name="shopid" type=hidden value="testshop">
		<input name="MerchantContinueURL" 	type=hidden value="https://cashcow.catpipe.net/authNBA/">
		<input name="MerchantDeclineURL" 	type=hidden value="http://nejtak.dk">
		<input name="MerchantTitle" 		type=hidden value="  ">
                <input name="OrderNo"                           type=hidden value="11111">
                <input name="MerchantAccount"           type=hidden value="3318850">
                <input name="AmountTrn"	             type=hidden value="111">
		<input name="CurrencyTrn" 		type=hidden value="DKK">
		<input name="AuthLifeCycle" 		type=hidden value="107">
		<input name="TestFlg" 			type=hidden value="T">
		<input name="DeviceCategory" 		type=hidden value="0">
		<input name="MerchantCountry" 		type=hidden value="208">
		<input name="MerchantUrl" 			type=hidden value="http://www..dk">
		<input name="MerchantGmtOffset" 	type=hidden value="01">
		<input name="MerchantBrands" 		type=hidden value="">
		<input name="PurchaseDate" 		type=hidden value="<?php echo date("ymd H:i:s"); ?>">
		<input name="PurchaseAmount" 		type=hidden value="DKK">
		<input name="PurchaseRecurring" 	type=hidden value="">
		<input name="PurchaseInstallment" 	type=hidden value="">
		<input name="PurchaseTerms" 		type=hidden value="">
		<input name="PurchaseShipto" 		type=hidden value="">

		<input name="paymenttype"	type=hidden value="NBA">
...
<p>Please enter your credit card information and double-check the 
	...
	to authorize thrugh your eBank(eDankort/NBA-link) <a href="#" onClick="eDankortRouter(AuthenticationInitialization);"><img border="0" src="images/edankort.gif"></a></p>
...
<input type="hidden" name="shopid" value="Telefonsexpiger">
<!-- 
